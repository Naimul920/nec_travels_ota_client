...
export default function HomeTabs() {
  ...
  return (
    <div className="w-full bg-[url('/assets/images/vector.png')] bg-top bg-no-repeat bg-size-[100%_auto]">
      ...
      <div className="relative z-40  rounded-2xl  border py-5  border-white/60 bg-white/15 shadow-[inset_0_1px_0_rgba(255,255,255,0.55),0_10px_40px_rgba(15,35,61,0.15)] backdrop-blur-xs mt-10">
        <Tabs
          activeKey={activeKey}
        ...
        >
          ...
          <TabPane key="3" tab="Visa" icon={<FiFileText size={20} />}>
            <div className="">Visa Information coming soon...</div>
          </TabPane>

          <TabPane key="4" tab="Holiday" icon={<MdHolidayVillage size={20} />}>
            <div className="">Holiday Information coming soon...</div>
          </TabPane>

          <TabPane key="5" tab="Umrah" icon={<FaKaaba size={20} />}>
            <div className="">Umrah Information coming soon...</div>
          </TabPane>
          ...
          >
            <div className="">Insurance Information coming soon...</div>
          </TabPane>
        </Tabs>
      </div>
    </div>
