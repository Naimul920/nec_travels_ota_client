...
const B2cSidebar: React.FC<SidebarProps> = ({
  ...
  const menuItemsRaw = [
    ...
    { key: "/b2c/hotel", label: "Hotel", icon: <FaHotel size={18} /> },
    { key: "/b2c/visa", label: "Visa", icon: <BsFillPassportFill size={18} /> },
    {
      key: "/b2c/insurance",
      label: "Insurance",
    ...
    { key: "/b2c/about", label: "About NEC Fly", icon: <MdInfo size={18} /> },
    {
      key: "/b2c/settings",
      label: "Setting",
