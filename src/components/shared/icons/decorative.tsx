export function AirplaneIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 34 32"
    ...
    >
      <path d="M0 13.4399L10.4592 19.0568L33.8299 0L0 13.4399Z" fill="#00A550" />
      <path d="M33.83 0L12.0615 20.5114L16.548 31.5373L33.83 0Z" fill="#FF000A" />
    </svg>
  );
}

export function DashedLineSvg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="277"
...
export function BottomAirplanesSvg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="109"
